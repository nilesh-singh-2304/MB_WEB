    ...
    <div>
              ...
              <div className="">
                  <div className="stats shadow">
                    <div className="stat">
                      ...
                      <div className="stat-title">National Competitions</div>
                      <div className="stat-value text-primary">5+</div>
                      <div className="stat-desc">Pragyan in upcoming month</div>
                    </div>
                    ...
                    <div className="stat">
                      ...
                      <div className="stat-title">University Comprtitions</div>
                      <div className="stat-value text-secondary">10+</div>
                      <div className="stat-desc">PCB War in upcoming month</div>
                    </div>
            ...
            <div key={item._id} className="bg-gray-700 rounded-md overflow-hidden cursor-pointer">
              ...
              <div className="p-6">
                ...
                <div className="flex">
                    ...
                    <label
                      htmlFor={item._id}
                      className="cursor-pointer btn btn-wide glass btn-accent text-white"
                    >
                      View More !!
                    </label>
      ...
      <div className="container mx-auto p-6 bg-gray-800 rounded-lg shadow-md">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div>
            <h2 className="text-3xl font-extrabold text-info mb-4">{item.onel}</h2>
            <p className="text-gray-100 text-sm leading-6">
             {item.desc}
            </p>
            <ul className="list-disc text-sm text-gray-200 space-y-2 pl-4 mt-6">
              <li>Timeline : {item.timeline}</li>
              <li>Mode : {item.mode}</li>
              <li>Prize Money : {item.prize}</li>
              <li>Level : {item.level}</li>
              <li>Category : {item.category}</li>
            </ul>
            <div className="mt-6">
              <Link href={item.yout}><SiYoutube className='text-4xl text-red-500 hover:text-red-600'/></Link>
            </div>
          </div>
        </div>
      </div>
