   ...
   <div className="bg-transparent px-4 py-12 font-[sans-serif]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto gap-8">
          {task.map((item) => (
            <div className="p-6 cursor-pointer flex gap-6 bg-opacity-25 bg-[url('https://e0.pxfuel.com/wallpapers/670/19/desktop-wallpaper-ben-10-symbols-ben-10-omniverse-omnitrix.jpg')] rounded-lg shadow-lg hover:shadow-2xl hover:scale-105 transition-all">
