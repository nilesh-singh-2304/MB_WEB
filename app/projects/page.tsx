        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <ul className="list-disc text-sm text-gray-200 space-y-2 pl-4 mt-6">
              ...
              <li>Motive : {item.motive}</li>
              <li>Category : {item.category}</li>
              <li>Displayed At : {item.disp}</li>
              <li>Project Lead : {item.projl}</li>
            </ul>
            <div className="mt-6 flex">
              <Link href={item.yout}><SiYoutube className='text-4xl text-red-500 hover:text-red-600'/></Link>
              <Link href={item.drive}><FaGoogleDrive className='text-3xl  text-blue-500 hover:text-blue-600 ml-3'/></Link>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div className="flex justify-center items-center">
                    ...
                    <Link href={item.insta}><FaInstagramSquare className="text-3xl hover:text-info mr-1" /></Link>
                  </div>
                </div>
              </div>
            </div>
